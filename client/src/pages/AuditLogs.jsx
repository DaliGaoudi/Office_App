            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'right' }}>
              <thead>
                <tr style={{ background: 'var(--surface-inset)', borderBottom: '1px solid var(--card-border)' }}>
                  <th style={{ padding: '1rem', fontSize: '0.9rem', color: 'var(--text-muted)', width: '15%' }}>Date & time</th>
                  ...
                  <th style={{ padding: '1rem', fontSize: '0.9rem', color: 'var(--text-muted)', width: '15%' }}>Module</th>
